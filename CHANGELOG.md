...
PyPI **pythonic-fp-circulararray** project. Fixed and variable capacity
circular array data structures.
...
- made pyproject.toml improvements
  ...
  - removed all version caps from pyproject.toml, see this `blog post <https://iscinumpy.dev/post/bound-version-constraints>`_.
